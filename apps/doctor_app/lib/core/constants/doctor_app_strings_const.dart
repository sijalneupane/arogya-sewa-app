...
const String emailValidation = "Email is required";
const String emailValidationString = "Enter a valid email";
const String passwordString = "Password";
const String passwordValidationString = "Password is required";
const String passwordLengthValidationString = "Min 6 characters";
const String forgotPasswordString = "Forgot Password?";
const String loginString = "Login";

const String loginWithScan = "Let me Scan your finger";
...
const String enterAPasswordString = "Enter a password";
const String confirmPasswordString = "Confirm Password";
const String reEnterPasswordString = "Re-enter password";
const String confirmYourPasswordString = "Confirm your password";
const String passwordNotMatchString = "Passwords do not match";

//settings and profile
const String profileString = "Profile";
const String apperanceString = "Appearance";
const String attendenceString = "Attendance";
const String biometricString = "Bio-metric";
const String leaveRequestString = "Leave Request";
...
const String welcomeUserString = "Welcome back";
const String todayAttendenceString = "Today's Attendance";
const String checkInString = "Check-In";
const String checkOutString = "Check-Out";
const String checkInSuccessString = "Checked in successfully";
const String checkOutSuccessString = "Checked out successfully";
const String alreadyCheckedInString = "You have already checked in for today";
const String notCheckedInString = "You have not checked in yet";
const String checkInFailedString = "Check-in failed. Please try again.";
const String checkOutFailedString = "Check-out failed. Please try again.";
const String fetchAttendanceIdFailedString = "Failed to fetch attendance Id";

const String editProfileString = "Edit Profile";
const String fullNameString = "Full Name";
const String addressString = "Address";
const String contactNoString = "Contact No ";
...
const String emergencycontactString = "Emergency Contact";
...
const String approvedRequestString = "Approved \nRequest";
const String rejectedRequestString = "Rejected \nRequest";
const String acceptedString = "Accepted";
const String rejectedString = "Rejected";
const String leaveRequestSubmitFailedString = "Failed to submit leave request";

const String leaveTypeMessage = "Leave Type";
...
const String dayRequestString = "Day Request";
const String singleDayString = "Single Day";
const String multipleDaysString = "Multiple Days";
const String halfDayString = "Half Day";
const String selectStartDateString = "Select start date";
const String selectEndDateString = "Select end date";
const String selectDateString = "Select date";
const String startTimeString = "Start Time";
const String endTimeString = "End Time";
const String selectStartTimeString = "Select start time";
const String selectEndTimeString = "Select end time";
const String submitString = "Submit";
const String timeFromString = "Time From";
const String timeToString = "Time To";
...
const String selectLeaveTypeString = "Please select a leave type";
const String selectDateValidationString = "Please select a date";
const String selectStartTimeValidationString = "Please select start time";
const String selectEndTimeValidationString = "Please select end time";
const String selectStartDateValidationString = "Please select start date";
...
// Leave type labels
const String annualString = "Annual";
...
const String multipleDayString = "Multiple Day";

const String chooseFromGalleryString = "Choose from Gallery";
const String takePhotoString = "Take Photo";
...
const String fillAllFieldsString = "Please fill in all required fields.";
const String contactNoValidatorString = " Enter a valid 10-digit number";
...
const String paginationPreviousString = "Previous";
const String paginationShowingString = "Showing";
const String totalRecordsString = "total Records";
